...
{
    NSString *plistPath = [[NSBundle mainBundle] pathForResource:@"emotionImage" ofType:@"plist"];
//    NSArray * emoji = [[NSArray alloc] initWithContentsOfFile:plistPath];
    NSMutableDictionary * emojiDic = [[NSMutableDictionary alloc]initWithContentsOfFile:plistPath];
    NSEnumerator * enumeratorKey = [emojiDic keyEnumerator];
    NSMutableArray * emojiArr = [[NSMutableArray alloc]init];
    for (NSObject *object in enumeratorKey) {
        
        NSString * emoji = (NSString *)object;
